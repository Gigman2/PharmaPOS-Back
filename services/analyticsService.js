...
module.exports = class AnalyticsService{ 
    ...
    async salesReport(body){
        var query = `
        SELECT SUM(CAST("grossTotal" AS decimal)) as closing_cash, SUM(CAST("cashAmount" AS decimal)) as cash, SUM(CAST("momoAmount" AS decimal)) as momo, MIN(id) as firstID, MAX(id) as lastID FROM  "public"."Sales" WHERE ("createdAt" BETWEEN '${body.from}' AND '${body.to}') GROUP BY "createdAt"::date`
